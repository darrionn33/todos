...
export default function settingsButton(params) {
  const settingsSvg = svg(
  ...
  const settingsButton = put("button.settings-button");

  settingsButton.onclick = () => {
    rootRender(settingsDiv());
  };

  put(settingsButton, settingsSvg);
